...
void spinlock_lock(spinlock_t *lock) {
  while (__sync_val_compare_and_swap(&lock->flag, 0, 1) != 0) {
...
void spinlock_unlock(spinlock_t *lock) {
  __sync_val_compare_and_swap(&lock->flag, 1, 0);
}
...
inline static void push(Object arg, int pid) {
    ...
    // Create a mutex using compare and swap to avoid the overhead of a system call
